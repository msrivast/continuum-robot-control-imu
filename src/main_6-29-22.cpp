...
void loop(){
    ...
    if(current_time - last_waypoint_time >= waypoint_interval){
        ...
        // interpolate_jones_space(0.35*PI/698.50,target_phi1,0.35*PI/698.50,target_phi2); //0.35 for VC_manu just so that it stays within the cage; 
        // interpolate_jones_space(0.0,target_phi1,0.5*PI/698.50,target_phi2);
