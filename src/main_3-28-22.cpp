...
void loop(){
    ...
    if(current_time - last_waypoint_time >= waypoint_interval){
        ...
        // interpolate_jones_space(0.35*PI/660.00,target_phi1,0.35*PI/710.00,target_phi2); //0.35 for VC_manu; 
        // interpolate_jones_space(0.8*PI/660.00,target_phi1,0.8*PI/710.00,target_phi2);
        // interpolate_jones_space(0.0,target_phi1,0.35*PI/710.00,target_phi2);
